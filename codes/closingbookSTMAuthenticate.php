...
$query = "SELECT * FROM expenses WHERE type = '4' AND date BETWEEN '${from_date}' AND '${end_date}' ORDER BY date DESC";
...
if ($result != false && $result != null) {
    ...
    foreach ($result as $keys => $value) {
        ...
        $subarray[] = '<a href="#" title="ইডিট" data-bs-toggle="modal" id="closingBookedit_load" data-id="' . $value['id'] . '" data-bs-target="#message4"><span class="text-warning" style="cursor: pointer; font-size: 22px;"><i class="bx bxs-edit"></i></span></a>';
