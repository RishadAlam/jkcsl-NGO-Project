...
$savings = $_POST['installment_savings'];
$total_loan = $_POST['total_loan'];
$expiry_date = $_POST['expiry_date'];
$total_intsallment = $_POST['loan_intsallment'];
$interest = $_POST['interest'];
$total_interest = $_POST['total_interest'];
$total_loan_w_ints = $_POST['total_money'];
$loan_installment = $_POST['installment'];
$interest_installment = $_POST['installment_interest'];
...
if (!imgExtValidate($nominee_img)) {
    ...
    if (move_uploaded_file($nominee_tmp_img, "../img/" . $nominee_img_name)) {
        $result = $reg->loanReg($feildID, $centerID, $periodID, $officerID, $clientID, $book, $savings, $total_loan, $total_intsallment, $interest, $total_interest, $total_loan_w_ints, $loan_installment, $interest_installment, $expiry_date, $total_loan, $total_interest, $nominee_name, $nominee_husband_name,  $nominee_father_name, $nominee_mother_name, $nominee_birth_reg_id_no, $nominee_nid, $nominee_occapasion, $relation, $nominee_gender, $nominee_img_name, $Nominee_address);
