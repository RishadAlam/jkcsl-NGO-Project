...
$result = $collection->savingsCollecReportload($period, $officer_id, $tamadi, $from_date, $end_date);
if ($result != false && $result != null) {
    ...
    foreach ($result as $keys => $value) {
        ...
        $subarray[] = date("d M, Y", strtotime($value['created_at_date'])) . '<br>' . date("h:i:s A", strtotime($value['created_at_time']));
