...
$query = "SELECT * FROM expenses WHERE type = '2' AND date BETWEEN '${from_date}' AND '${end_date}' ORDER BY id DESC";
...
if ($result != false && $result != null) {
    ...
    foreach ($result as $keys => $value) {
        ...
        $subarray[] = '<a href="#" title="ইডিট" data-bs-toggle="modal" id="fdredit_load" data-id="' . $value['id'] . '" data-bs-target="#message3"><span class="text-warning" style="cursor: pointer; font-size: 22px;"><i class="bx bxs-edit"></i></span></a>';
