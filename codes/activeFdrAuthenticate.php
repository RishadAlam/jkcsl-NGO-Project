...
if ($_SESSION['auth']['user_role'] == 0) {
    ...
    if ($result != false && $result != null) {
        ...
        foreach ($result as $keys => $value) {
            ...
            $subarray[] = '<span class="d-inline-block py-1 px-4 text-capitalize bg-success rounded" style="color: #fff; font-size: 18px;">ACTIVE</span>';
            $subarray[] = '<div class="form-check form-switch text-center">
                                            <input class="form-check-input" name="action" checked type="checkbox" role="switch" id="' . $value['id'] . '">
