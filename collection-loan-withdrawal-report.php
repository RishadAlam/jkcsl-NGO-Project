        ...
        <div class="table">
            <div class="recent_collection">
                <div class="table_heading d-flex align-items-center justify-content-between my-3">
                    <h4>ঋণ সঞ্চয় উত্তোলন রিপোর্ট</h4>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#officers").on("change", function() {
            ...
            setTimeout(function() {
                loan_withdrawalReportLoad(officer);
            }, 1000)
        })
        ...
        if (report != null) {
            ...
            function loan_withdrawalReportLoad(officer = null) {
                $('#withdrawal_loan_report').DataTable({
                    // "processing": true,
                    // "serverSide": true,
                    ...
                    "searching": true,
                    "ajax": {
                        url: "codes/collectionsLoanWithdrawalAuthenticate.php",
                        type: "POST",
                        data: {
                            report: report,
                            officer: officer
