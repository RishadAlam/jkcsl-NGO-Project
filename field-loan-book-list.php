            ...
            <ol class="breadcrumb d-flex justify-content-center">
                ...
                <li class="breadcrumb-item"><a href="<?php
                                                        if (isset($_GET["field"])) {
                                                            ...
                                                            echo baseUrl('loan-periods') . '?period=' . $_GET['period'];
...
<script>
    $(document).ready(function() {
        ...
        let loan = urlParams.get('loan');
        let loanClose = urlParams.get('loanClose');
        let centerID = null;
        ...
        if (fieldID != null) {
            ...
            loadPeriod();
            if (loan == 1) {
                $("#breadcrumb_subname").text("একটিভ ঋণ সদস্য");
                ...
                function reportLoad(center = null, period = null) {
                    $('#client_account_list').DataTable({
                        ...
                        "searching": true,
                        "ajax": {
                            url: "codes/loansActiveACCAuthenticate.php",
                            type: "POST",
                            data: {
                                fieldID: fieldID,
                                center: center,
                ...
                $("#breadcrumb_subname").text("ক্লোজ ঋণ সদস্য");
                ...
                function reportLoad(center = null, period = null) {
                    $('#client_account_list').DataTable({
                        ...
                        "searching": true,
                        "ajax": {
                            url: "codes/loansDeactiveACCAuthenticate.php",
                            type: "POST",
                            data: {
                                fieldID: fieldID,
                                center: center,
