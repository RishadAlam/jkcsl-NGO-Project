        ...
        <div class="table">
            <div class="recent_collection">
                <div class="table_heading d-md-flex align-items-center justify-content-between my-3">
                    ...
                    <?php if ($_SESSION['auth']['user_role']) {}else{ ?>
...
<script>
    $(document).ready(function() {
        ...
        function reportPrint() {
            window.open('<?= baseUrl("collection-print-report") ?>?report=' + report + '&&officer=' + $("#officers").val() + '&&date=null&&savings=1');
        }
        ...
        if (report != null) {
            ...
            function reportLoad(officer = null) {
                $('#collection_savings_report').DataTable({
                    // "processing": true,
                    // "serverSide": true,
                    ...
                    "searching": true,
                    "ajax": {
                        url: "codes/collectionSavingsAuthenticate.php",
                        type: "POST",
                        data: {
                            report: report,
                            officer: officer,
