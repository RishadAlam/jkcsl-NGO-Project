                ...
                <div class="savings_active_clients">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="<?= baseUrl('field-savings-book-list') ?>?field=<?= $_GET['field'] ?>&savings=1" class="d-flex justify-content-between"><span>বই দেখুন</span><span><i class='bx bxs-chevrons-right'></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="savings_active_clients">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="<?= baseUrl('field-savings-book-list') ?>?field=<?= $_GET['field'] ?>&savingsClose=1" class="d-flex justify-content-between"><span>বই দেখুন</span><span><i class='bx bxs-chevrons-right'></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="savings_active_clients">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="<?= baseUrl('field-loan-book-list') ?>?field=<?= $_GET['field'] ?>&loan=1" class="d-flex justify-content-between"><span>বই দেখুন</span><span><i class='bx bxs-chevrons-right'></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="savings_active_clients">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="<?= baseUrl('field-loan-book-list') ?>?field=<?= $_GET['field'] ?>&loanClose=1" class="d-flex justify-content-between"><span>বই দেখুন</span><span><i class='bx bxs-chevrons-right'></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="chart_body">
                    <div class="savings_chart p-4">
                        <div class="chart_heading mb-3">
                            <h4>চলতি মাসের সাধারণ সঞ্চয় সংগ্রহ হয়েছে <span id="total_savings_chart"></span> টাকা</h4>
                        </div>
                        <div>
