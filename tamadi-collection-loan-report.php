    ...
    $(document).ready(function() {
        ...
        window.addEventListener('load', function() {
            ...
            function reportPrint() {
                window.open('<?= baseUrl("collection-print-report") ?>?report=' + report + '&&officer=' + $("#officers").val() + '&&from_date=' + from_date + '&&end_date=' + end_date + '&&tamadiLoan=1');
            }
            ...
            if (report != null) {
                ...
                function reportLoad(officer = null) {
                    $('#tamadi_collection_loan_report').DataTable({
                        // "processing": true,
                        // "serverSide": true,
                        ...
                        "searching": true,
                        "ajax": {
                            url: "codes/tamadicollectionloanAuthenticate.php",
                            type: "POST",
                            data: {
                                report: report,
                                officer: officer,
